...
<svelte:head>
  <title>Privacy Policy | InnerEcho</title>
  <meta name="description" content="Privacy Policy for InnerEcho mental health journaling app. Your privacy is our priority." />
</svelte:head>
...
<style>
  ...
  .policy-intro {
    ...
    border-bottom: 1px solid rgba(33, 60, 78, 0.1);
  }
