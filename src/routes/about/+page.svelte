  ...
  <div class="hero-content container">
    <div class="hero-text">
      ...
      <div class="hero-cta" class:visible={mounted}>
        ...
        <a href="https://www.linkedin.com/in/quinn-odonnell/" target="_blank" rel="noopener" class="btn btn-outline btn-outline-light" data-cursor-expand data-cursor-text="Link">LinkedIn</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="connect-content">
      ...
      <div class="connect-links">
        ...
        <a href="https://www.linkedin.com/in/quinn-odonnell/" target="_blank" rel="noopener" class="connect-link" data-cursor-text="Link">
          <div class="connect-link-icon">
